...
import cn.edu.hcnu.auth.domain.service.gitee.GiteeUUIDSecurityConfig;
import cn.edu.hcnu.auth.domain.service.password.PhonePasswordSecurityConfig;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeRequests()
                // 注销的接口需要放行
                .antMatchers("/oauth/logout", "/**/logout", "/**/user/new","/**/user/*","/**/user/update", "/**/login", "**/check_token", "**/v3/api-docs/**","/v3/api-docs/**").permitAll()
