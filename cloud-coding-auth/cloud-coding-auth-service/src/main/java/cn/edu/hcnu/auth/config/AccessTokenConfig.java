 ...
 * @Version: 2.0
 * @Author: AICHEN
 * @Date: 2023-06-05 13:44:26
 * @LastEditors: AICHEN
 * @LastEditTime: 2023-06-05 14:48:18
 */
...
public class AccessTokenConfig {
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter() {
        ...
        // 设置秘钥
        converter.setSigningKey(CloudCodingConstant.SIGN_KEY);
        /*
    ...
    public static class JwtAccessTokenEnhancer extends JwtAccessTokenConverter {
        ...
        public OAuth2AccessToken enhance(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
            ...
            if (principal instanceof SecurityUser) {
                ...
                // 设置用户的userId
                extendInformation.put(CloudCodingConstant.USER_ID, user.getUserId());
