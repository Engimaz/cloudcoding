...
import cn.edu.hcnu.auth.domain.service.gitee.GiteeUUIDGranter;
import cn.edu.hcnu.auth.domain.service.password.PhonePasswordGranter;
import cn.edu.hcnu.auth.exception.OAuthServerAuthenticationEntryPoint;
import cn.edu.hcnu.auth.filter.OAuthServerClientCredentialsTokenEndpointFilter;
