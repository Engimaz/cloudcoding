...
import cc.cloudcoding.auth.domain.service.gitee.GiteeUUIDGranter;
import cc.cloudcoding.auth.domain.service.password.PhonePasswordGranter;
import cc.cloudcoding.auth.exception.OAuthServerAuthenticationEntryPoint;
import cc.cloudcoding.auth.filter.OAuthServerClientCredentialsTokenEndpointFilter;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        tokenGranters.add(new GiteeUUIDGranter(authenticationManager, tokenServices(), clientDetailsService,
                new DefaultOAuth2RequestFactory(clientDetailsService)));
    ...
    public void configure(AuthorizationServerSecurityConfigurer security) {
        ...
        OAuthServerClientCredentialsTokenEndpointFilter endpointFilter = new OAuthServerClientCredentialsTokenEndpointFilter(
