package cn.edu.hcnu.gateway.config.security;

import cn.edu.hcnu.gateway.exception.RequestAuthenticationEntryPoint;
import cn.hutool.core.util.ArrayUtil;
import cn.edu.hcnu.gateway.exception.RequestAccessDeniedHandler;
import cn.edu.hcnu.gateway.filter.CorsFilter;
 ...
 *         网关的OAuth2.0资源的配置类
 *         由于spring cldou
 *         gateway使用的Flux，因此需要使用@EnableWebFluxSecurity注解开启，而不是平常的web应用了
 */
@Configuration
