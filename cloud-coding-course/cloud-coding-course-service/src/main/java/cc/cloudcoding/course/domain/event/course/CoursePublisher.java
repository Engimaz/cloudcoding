package cc.cloudcoding.course.domain.event.course;

import cc.cloudcoding.course.domain.event.course.add.AddCourseEvent;
import cc.cloudcoding.course.domain.event.course.remove.RemoveCourseEvent;
import cc.cloudcoding.course.domain.event.course.update.UpdateCourseEvent;
